...
// R16-ийн feeder = R32 МАТЧИЙН id-слот (1-based, ESPN event id-ийн дараалал).
// ESPN-ийн "Round of 32 N" нь FIFA матчийн дугаар (N+72)-ыг заадаг — id-дараалал БИШ.
// Тиймээс feeder бүрийг FIFA матч → албан ёсны bracket (Wikipedia) → id-слот руу зөв буулгасан.
// Шалгасан: R16 хослолууд FIFA-ийн жинхэнэ модтой яг таарна (POR↔ENG зөвхөн финалд тулна).
export const BRACKET_TREE = {
  R16: [[1, 3], [4, 7], [2, 5], [6, 10], [11, 12], [9, 8], [13, 16], [15, 14]],
  QF: [[1, 2], [5, 6], [3, 4], [7, 8]],
  SF: [[1, 2], [3, 4]],
  F: [[1, 2]],
};
